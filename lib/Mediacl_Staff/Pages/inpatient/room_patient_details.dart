...
class _WardsAndBedsPageState extends State<WardsAndBedsPage> {
  ...
  Future<void> _loadHospitalInfo() async {
    ...
    setState(() {
      ...
      hospitalPhoto = prefs.getString('hospitalPhoto') ?? "https://as1.ftcdn.net/v2/jpg/02/50/38/52/1000_F_250385294_tdzxdr2Yzm5Z3J41fBYbgz4PaVc2kQmT.jpg";
    });
  }
  Future<void> fetchWards() async {
    ...
    if (res.statusCode == 200) {
      ...
      final filtered = data.where((ward) => (ward['beds'] as List).isNotEmpty).toList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Wards & Beds", style: TextStyle(color: Colors.white)),
              ...
              return Container(
                ...
                child: Stack(
                  children: [
                    // ===== MAIN WARD CARD =====
                    Padding(
                      padding: const EdgeInsets.only(top: 18), // space for header overlap
                      child: Card(
                        color: Colors.white,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ...beds.expand<Widget>((bed) {
                                final admissions = bed['admissions'] as List;
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (_) =>
                                              AdmissionDetailPage(admission: admission),
                                        ),
                                      );
                                    },
                                    child: Card(
